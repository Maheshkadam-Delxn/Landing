...
<div className="text-white font-mono font-bold text-3xl p-2 flex items-center">
  <Image src="/images/logo.jpg" alt="Logo" width={40} height={32} className="mr-2 rounded-full " />
  DevServe
</div>
      ...
      <div className="w-full sm:w-auto flex items-center justify-center gap-12 pt-4 sm:pt-0 pb-4 sm:pb-0 text-lg font-medium rounded-b-lg">
        <Link
          to="Home"
          smooth={true}
          className="relative text-white text-base cursor-pointer hover:text-slate-300 after:content-[''] after:block after:h-[2px] after:bg-white after:w-0 after:transition-all after:duration-300 hover:after:w-full"
        >
          Home
        </Link>
        <Link
