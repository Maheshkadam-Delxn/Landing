...
const Navbar = () => {
  return (
    <main className="bg-[#121212] flex flex-col sm:flex-row items-center justify-between px-6 py-4 shadow-md ">
      ...
      <div className=" sm:w-auto flex items-center justify-center gap-10 pt-4 sm:pt-0 pb-4 sm:pb-0 text-lg font-medium rounded-b-lg">
        ...
        <Link
          ...
          className="p-2 bg-blue-500  rounded-md text-white text-base cursor-pointer hover:bg-[#164574]"
        >
          Contact Us
        </Link>
      </div>
